...
from otx.algo.diffusion.model.ldm.taming.data.annotated_objects_dataset import AnnotatedObjectsDataset
from otx.algo.diffusion.model.ldm.taming.data.helper_types import Annotation, ImageDescription, Category
